...
cat <<'DATA' | sudo tee -a /etc/portage/package.use/c64dev-java
...
DATA
cat <<'DATA' | sudo tee -a /etc/portage/package.use/c64dev-vice
...
cat <<'DATA' | sudo tee -a /etc/portage/package.license/c64dev-libpng
# required by openjdk:
